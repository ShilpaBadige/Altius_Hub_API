...
*** Test Cases ***
case1:get-partner-locationidentity API with positive flow
     create session    post_01   ${Altius_Hub_Base_Url}     verify=${TRUE}
#   ${body}=   create dictionary   to json    ${EMPTY}
    ${header}=  create dictionary    Content-Type=application/json
     ${response}=  get request    post_01   /mah/api/principle_database/get-partner-locationidentity     headers=${header}
